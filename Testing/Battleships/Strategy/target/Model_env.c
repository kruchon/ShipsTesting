...
extern void xOutEnv( xSignalNode *SignalOut )
{
  ...
  /* Signals going to the env via the channel StSimInt */
    ...
    IF_OUT_SIGNAL(OrderSpeedRequest,"OrderSpeedRequest")
      ...
      XENV_BUF(BufInitWriteMode(Buf));
      XENV_ENC(ASCIIEncode(Buf, (tSDLTypeInfo *)&ySDL_z_BasicTypes_1M_tShipId,
  ...
  /* Signals going to the env via the channel StMsgInt */
    ...
    /* Signal booms */
    IF_OUT_SIGNAL(booms,"booms")
      OUT_SIGNAL1(booms,"booms")
      XENV_BUF(BufInitWriteMode(Buf));
      XENV_ENC(ASCIIEncode(Buf, (tSDLTypeInfo *)&ySDL_SDL_Integer,
        (void *)&((yPDef_booms *)(*SignalOut))->Param1));
      OUT_SIGNAL2(booms,"booms")
      XENV_BUF(BufCloseWriteMode(Buf));
      RELEASE_SIGNAL
    END_IF_OUT_SIGNAL(booms,"booms")

    /* Signal found */
    IF_OUT_SIGNAL(found,"found")
      OUT_SIGNAL1(found,"found")
      XENV_BUF(BufInitWriteMode(Buf));
      XENV_ENC(ASCIIEncode(Buf, (tSDLTypeInfo *)&ySDL_SDL_Integer,
        (void *)&((yPDef_found *)(*SignalOut))->Param1));
      XENV_ENC(ASCIIEncode(Buf, (tSDLTypeInfo *)&ySDL_SDL_Integer,
        (void *)&((yPDef_found *)(*SignalOut))->Param2));
      OUT_SIGNAL2(found,"found")
      XENV_BUF(BufCloseWriteMode(Buf));
      RELEASE_SIGNAL
    END_IF_OUT_SIGNAL(found,"found")
}
...
#endif
{
  ...
  IF_IN_SIGNAL(DestroyShip,"DestroyShip")
    ...
    XENV_DEC(ASCIIDecode(Buf, (tSDLTypeInfo *)&ySDL_z_BasicTypes_1M_tShipId,
      (void *)&((yPDef_DestroyShip *)SignalIn)->Param1));
    XENV_DEC(ASCIIDecode(Buf,
      (tSDLTypeInfo *)&ySDL_z_BasicTypes_1N_tStrategyId,
      (void *)&((yPDef_DestroyShip *)SignalIn)->Param2));
    XENV_DEC(ASCIIDecode(Buf, (tSDLTypeInfo *)&ySDL_z_BasicTypes_0W_tNameShip,
