...
#
###############################################################################
# command line: 'C:\Testing\TAT\bin\atsgen.exe -m @C:/Testing/work/macroprc.lst -o C:/Testing/work/battleshipstest.tcl -incl types.h model.ifc -cname default -tt -asn1 -state -mf -nia -nic -config C:/Testing/config.sic '
...
[ list  [list "C:\\Testing\\BSTest\\mpr\\test8\\Test8.mpr" 1 5 12 ]\
[list "C:\\Testing\\work\\Test8N0.mpr" 2 5 12 ]\
]\
[ list \
 [list  0  1  ]\
 [list  0  1  ]\
...
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 7 ] [list 1 7 ] ] "" "" [list  12 [ list [ list "" "1"  ] [ list "" [list ARRAY [list STRUCT "1" "1" "CRUISER" "0" "EAST" "50" [list STRUCT "20" "50"] [list ARRAY "10" "10" "10" "0"] "0" "0" "0" [list STRUCT "25" "25"]]]  ]  ]  1 [ list REL "0" "0" ] ] ]\
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 2  PASS  [list [list 0 9 ] [list 1 9 ] ] "" "" [list  13 [ list [ list "" "1"  ]  ]  2 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 3  PASS  [list [list 0 11 ] [list 1 11 ] ] "" "" [list  1 [ list [ list "" "1"  ] [ list "" "1"  ]  ]  3 [ list REL "0" "0" ] ] ]\
] 1 0
