...
extern TAT_SIG_booms model_sigbooms;
extern TAT_EVENT_INSTANCE model_evbooms;


extern TAT_SIG_found model_sigfound;
extern TAT_EVENT_INSTANCE model_evfound;
...
int battleshipstest_Recv_booms(int, int, int);
int battleshipstest_Recv_found(int, int, int, int);
