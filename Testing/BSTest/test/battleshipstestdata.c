...
static TAT_SIG_PARAM_DEF tat_SIG_PARAM_booms[]={
	{34,"Param1",sizeof(int), offsetof(TAT_SIG_booms, Param1), TAT_Dump_int}
};
static TAT_SIG_PARAM_DEF tat_SIG_PARAM_found[]={
	{35,"Param1",sizeof(int), offsetof(TAT_SIG_found, Param1), TAT_Dump_int},
	{36,"Param2",sizeof(int), offsetof(TAT_SIG_found, Param2), TAT_Dump_int}
};
static TAT_SIG_PARAM_DEF tat_SIG_PARAM_messageError[]={
	{37,"Param1",sizeof(SDL_Charstring), offsetof(TAT_SIG_messageError, Param1), TAT_Dump_String}
};
static TAT_SIG_PARAM_DEF tat_SIG_PARAM_messageLog[]={
	{38,"Param1",sizeof(SDL_Charstring), offsetof(TAT_SIG_messageLog, Param1), TAT_Dump_String}
};
static TAT_SIGNAL_DEF tat_SignalDefinition[]={
	...
	{          TAT_S_booms_ID,	"booms", sizeof(TAT_SIG_booms), 1, (TAT_SIG_PARAM_DEF *)&tat_SIG_PARAM_booms, 100},
	{          TAT_S_found_ID,	"found", sizeof(TAT_SIG_found), 2, (TAT_SIG_PARAM_DEF *)&tat_SIG_PARAM_found, 100},
